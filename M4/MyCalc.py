# UCID: RG695
# Date: 02/27/2023
#Summary: This is the python code to make a simple calculator using functions like addition, subtraction, multiplication and division.
#And to test we are writing test cases. "main" method is used to input the equation and get the solution.
