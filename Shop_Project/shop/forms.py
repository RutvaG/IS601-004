...
class CheckoutForm(FlaskForm):
    ...
    apt = StringField("Address", validators=[DataRequired(), Length(max=30)])
    ...
    zpcode = StringField("Zipcode", validators=[DataRequired(), Length(max=15)])
